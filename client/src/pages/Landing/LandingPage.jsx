    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="py-24 bg-gradient-to-b from-gray-50 to-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent inline-block">
              See How OrtonAI Helps Influencers
            </h2>
            <div className="mt-4 h-1 w-24 bg-gradient-to-r from-indigo-600 to-purple-600 mx-auto rounded-full" />
            <p className="mt-6 text-lg text-gray-600 max-w-2xl mx-auto">
              Watch how OrtonAI streamlines content creation and management for influencers
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            {/* Video 1 */}
            <div id="video-1" className="scroll-animate">
                ...
                <div className="relative bg-white rounded-2xl shadow-xl overflow-hidden">
                  <div className="aspect-w-16 aspect-h-9">
                    <iframe 
                      ...
                      title="Content Creation with OrtonAI"
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-600">
                      Learn how OrtonAI helps influencers generate video ideas, optimize content, and analyze performance metrics
                    </p>
                  </div>
                </div>
              </div>
            ...
            {/* Video 2 */}
            <div id="video-2" className="scroll-animate">
                ...
                <div className="relative bg-white rounded-2xl shadow-xl overflow-hidden">
                  <div className="aspect-w-16 aspect-h-9">
                    <iframe 
                      ...
                      title="Content Management with OrtonAI"
                      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
                      allowFullScreen
                    />
                  </div>
                  <div className="p-6">
                    ...
                    <p className="text-gray-600">
                      Discover how OrtonAI automates scheduling, analytics, and engagement tracking across multiple platforms
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            <div className="absolute top-1/4 -left-48 w-96 h-96 bg-indigo-100 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob" />
            <div className="absolute top-1/3 -right-48 w-96 h-96 bg-purple-100 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-2000" />
          </div>
        </div>
      </div>
