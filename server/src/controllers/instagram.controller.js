...
//     const engagementMetrics = await axios.get(
//       `https://graph.facebook.com/v18.0/${user.instagramBusinessId}/insights`,
//       {
//         params: {
...
//       }
//     );
//     console.log('Engagement metrics received:', {
//       hasData: !!engagementMetrics.data,
//       dataLength: engagementMetrics.data?.data?.length
//     });
...
//       hasData: !!mediaResponse.data,
//       postsCount: mediaResponse.data?.data?.length
//     });

//     // Safely extract metrics values
//     const metricsData = engagementMetrics.data?.data || [];
//     const processedData = {
//       reach: metricsData.find(m => m.name === 'reach')?.values?.[0]?.value || 0,
//       impressions: metricsData.find(m => m.name === 'impressions')?.values?.[0]?.value || 0,
//       accounts_engaged: metricsData.find(m => m.name === 'accounts_engaged')?.values?.[0]?.value || 0,
...
//       hasReach: !!processedData.reach,
//       hasImpressions: !!processedData.impressions,
//       postsCount: processedData.recent_posts.length
//     });
