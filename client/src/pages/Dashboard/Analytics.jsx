...
// import { Loader2, TrendingUp, Users, Eye, MessageCircle, Heart, Share2 } from 'lucide-react';
...
//               <p className="mt-1 text-xl font-semibold text-gray-900">
//                 {formatNumber(insights?.metrics?.reach || 0)}
//               </p>
//             </div>
//           </div>
//         </Card>
...
//           {insights?.performance?.best_performing_posts?.map((post, index) => (
...
//             </div>
//           ))}
//           {(!insights?.performance?.best_performing_posts || insights.performance.best_performing_posts.length === 0) && (
...
//           <ResponsiveContainer width="100%" height="100%">
//             <BarChart
//               data={insights?.recent_posts?.slice(0, 5) || []}
//               margin={{ top: 5, right: 30, left: 20, bottom: 5 }}
//             >
//               <CartesianGrid strokeDasharray="3 3" />
//               <XAxis dataKey="date" />
...
//               <Bar dataKey="comments" fill="#818CF8" name="Comments" />
//             </BarChart>
//           </ResponsiveContainer>
//         </div>
//       </Card>
...
// client/src/pages/Dashboard/Analytics.jsx

import { useState, useEffect } from 'react';
import { Card } from '../../components/ui/card';
import { LineChart, Line, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer, BarChart, Bar } from 'recharts';
import { Loader2, TrendingUp, Users, Eye, MessageCircle, Heart } from 'lucide-react';
import * as instagramService from '../../services/instagram.service';
